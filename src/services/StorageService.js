...
export const StorageService = {
  ...
  seedSampleData() {
    const sampleTickets = [
      {
        id: '#TK-2024-0001',
        guestName: 'Tamu Test A',
        roomNumber: '301',
        roomType: 'Deluxe Room',
        phone: '0812-0000-0001',
        email: 'test.a@hotel.local',
        itemName: 'Smartwatch Hitam',
        category: 'Elektronik',
        brand: 'Smartwatch',
        color: 'Hitam',
        locationLost: 'Meja Nakas',
        secretDetail: 'Ada goresan di sisi kiri',
        priority: 'Reguler',
        status: 'Menunggu Verifikasi',
        reportedAt: 'Hari ini, 10:00 WIB',
        createdAt: new Date().toISOString()
      },
      {
        id: '#TK-2024-0002',
        guestName: 'Tamu Test B',
        roomNumber: '405',
        roomType: 'Superior Room',
        phone: '0812-0000-0002',
        email: 'test.b@hotel.local',
        itemName: 'Cincin Emas',
        category: 'Perhiasan & Jam',
        brand: '-',
        color: 'Emas Kuning',
        locationLost: 'Wastafel Kamar Mandi',
        secretDetail: 'Grafir inisial di lingkar dalam',
        priority: 'Reguler',
        status: 'Terverifikasi',
        reportedAt: 'Hari ini, 11:00 WIB',
        createdAt: new Date().toISOString()
      }
    ];
    ...
    const sampleFound = [
      {
        ...
        roomNumber: '301',
        category: 'Elektronik',
        locationFound: 'Meja Nakas',
        storageLocation: 'Loker FO B-01',
        finderName: 'Petugas HK Lantai 3',
        foundAt: 'Hari ini, 09:30 WIB',
      ...
      },
      {
        ...
        finderName: 'Petugas HK Lantai 4',
        foundAt: 'Hari ini, 10:15 WIB',
        status: 'Di Brankas FO',
    ...
    const sampleGuests = [
      ...
      },
      {
        ...
        roomNumber: '405',
        roomType: 'Superior Room',
        checkoutTime: '11:30 WIB',
        checkoutAgo: '1 jam lalu',
        status: 'replied',
